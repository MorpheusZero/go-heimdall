...
func NewHeimdall(connectionString string, migrationTableName string, migrationFilesDirectoryPath string, verbose bool) *Heimdall {
	db := NewHeimdallDatabase(connectionString)
...
func initializeMigrationHistoryTable(db *HeimdallDatabase, migrationTableName string) error {
	sql := fmt.Sprintf(`
...
func getMigrationsInDB(db *HeimdallDatabase, migrationTableName string) ([]string, error) {
	sql := fmt.Sprintf(`
		SELECT filename 
			FROM public.%s
...
func performMigrations(migrations []MigrationFile, db *HeimdallDatabase, migrationTableName string, verbose bool) error {
